...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 72)(__webpack_require__(/*! App/Admin */ 16));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			CoreStore = __webpack_require__(/*! Stores/Admin/Core */ 83),
		...
		AdminApp.prototype.bootstart = function ()
		{
			...
			else
			{
				...
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Settings */ 111)
					]);
				}
				else
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Login */ 110)
					]);
				}
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! App/Admin */ 16).setWindowTitle('');
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/General */ 120),
				'AdminSettingsGeneral', 'General', 'general', true);

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Login */ 122),
				'AdminSettingsLogin', 'Login', 'login');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Branding */ 117),
				'AdminSettingsBranding', 'Branding', 'branding');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Contacts */ 118),
				'AdminSettingsContacts', 'Contacts', 'contacts');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Domains */ 119),
				'AdminSettingsDomains', 'Domains', 'domains');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Security */ 125),
				'AdminSettingsSecurity', 'Security', 'security');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Social */ 126),
				'AdminSettingsSocial', 'Integrations', 'integrations');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Plugins */ 124),
				'AdminSettingsPlugins', 'Plugins', 'plugins');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Packages */ 123),
				'AdminSettingsPackages', 'Packages', 'packages');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Licensing */ 121),
				'AdminSettingsLicensing', 'Licensing', 'licensing');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/About */ 116),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 88));
		};
		...
		DomainsAdminSettings.prototype.onDomainLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 88), [oData.Result]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 87));
		};

		LicensingAdminSettings.prototype.showTrialForm = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 87), [true]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		PluginsAdminSettings.prototype.onPluginLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Plugin */ 148), [oData.Result]);
			}
		};
