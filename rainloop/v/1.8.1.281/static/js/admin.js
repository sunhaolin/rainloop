...
(function () {
	...
	var
		...
		AppStore = __webpack_require__(/*! Stores/Admin/App */ 36),
		DomainStore = __webpack_require__(/*! Stores/Admin/Domain */ 62),
		PluginStore = __webpack_require__(/*! Stores/Admin/Plugin */ 65),
		LicenseStore = __webpack_require__(/*! Stores/Admin/License */ 63),
		PackageStore = __webpack_require__(/*! Stores/Admin/Package */ 64),
		CoreStore = __webpack_require__(/*! Stores/Admin/Core */ 82),
		Remote = __webpack_require__(/*! Remote/Admin/Ajax */ 16),
	...
	AdminApp.prototype.bootstart = function ()
	{
		...
		__webpack_require__(/*! Stores/Admin/App */ 36).populate();
		...
		else
		{
			...
			{
				kn.startScreens([
					__webpack_require__(/*! Screen/Admin/Settings */ 110)
				]);
			}
			else
			{
				kn.startScreens([
					__webpack_require__(/*! Screen/Admin/Login */ 109)
				]);
			}
		}
...
(function () {
	...
	DomainPopupView.prototype.onDomainCreateOrSaveResponse = function (sResult, oData)
	{
		...
		if (Enums.StorageResultType.Success === sResult && oData)
		{
			if (oData.Result)
			{
				__webpack_require__(/*! App/Admin */ 15).reloadDomainList();
				this.closeCommand();
			}
...
(function () {
	...
	function LoginAdminScreen()
	{
		AbstractScreen.call(this, 'login', [
			__webpack_require__(/*! View/Admin/Login */ 139)
		]);
	}
	...
	{
		__webpack_require__(/*! App/Admin */ 15).setWindowTitle('');
	};
...
(function () {
	...
	var
		...
		AbstractSettings = __webpack_require__(/*! Screen/AbstractSettings */ 61)
	;
	...
	function SettingsAdminScreen()
	{
		AbstractSettings.call(this, [
			__webpack_require__(/*! View/Admin/Settings/Menu */ 140),
			__webpack_require__(/*! View/Admin/Settings/Pane */ 141)
		]);
	}
	...
	{
		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/General */ 119),
			'AdminSettingsGeneral', 'General', 'general', true);

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Login */ 121),
			'AdminSettingsLogin', 'Login', 'login');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Branding */ 116),
			'AdminSettingsBranding', 'Branding', 'branding');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Contacts */ 117),
			'AdminSettingsContacts', 'Contacts', 'contacts');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Domains */ 118),
			'AdminSettingsDomains', 'Domains', 'domains');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Security */ 124),
			'AdminSettingsSecurity', 'Security', 'security');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Social */ 125),
			'AdminSettingsSocial', 'Integrations', 'integrations');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Plugins */ 123),
			'AdminSettingsPlugins', 'Plugins', 'plugins');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Packages */ 122),
			'AdminSettingsPackages', 'Packages', 'packages');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Licensing */ 120),
			'AdminSettingsLicensing', 'Licensing', 'licensing');

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/About */ 115),
...
(function () {
	...
	AboutAdminSettings.prototype.onBuild = function ()
	{
		if (this.access())
		{
			__webpack_require__(/*! App/Admin */ 15).reloadCoreData();
		}
	};
	...
	AboutAdminSettings.prototype.updateCoreData = function ()
	{
		...
		{
			__webpack_require__(/*! App/Admin */ 15).updateCoreData();
		}
	};
...
(function () {
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 87));
	};
	...
	DomainsAdminSettings.prototype.onDomainLoadRequest = function (sResult, oData)
	{
		if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
		{
			__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 87), [oData.Result]);
		}
	};
...
(function () {
	...
	var
		...
		AppAdminStore = __webpack_require__(/*! Stores/Admin/App */ 36),
		CapaAdminStore = __webpack_require__(/*! Stores/Admin/Capa */ 43),
...
(function () {
	...
	function LicensingAdminSettings()
	{
		...
		this.licenseTrigger.subscribe(function () {
			...
			{
				__webpack_require__(/*! App/Admin */ 15).reloadLicensing(true);
			}
		}, this);
	}
	...
	LicensingAdminSettings.prototype.onBuild = function ()
	{
		if (this.subscriptionEnabled())
		{
			__webpack_require__(/*! App/Admin */ 15).reloadLicensing(false);
		}
	};
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 86));
	};

	LicensingAdminSettings.prototype.showTrialForm = function ()
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 86), [true]);
	};
...
(function () {
	...
	{
		__webpack_require__(/*! App/Admin */ 15).reloadPackagesList();
	};
...
(function () {
	...
	PluginsAdminSettings.prototype.onShow = function ()
	{
		...
		__webpack_require__(/*! App/Admin */ 15).reloadPluginList();
	};
		...
		this.submitCommand = Utils.createCommand(this, function () {
			...
			Remote.adminLogin(_.bind(function (sResult, oData) {
				...
				if (Enums.StorageResultType.Success === sResult && oData && 'AdminLogin' === oData.Action)
				{
					if (oData.Result)
					{
						__webpack_require__(/*! App/Admin */ 15).loginAndLogoutReload();
					}
					else if (oData.ErrorCode)
					{
...
(function () {
	...
	function PaneSettingsAdminView()
	{
		...
		this.adminManLoading = ko.computed(function () {
			return '000' !== [
				__webpack_require__(/*! Stores/Admin/Domain */ 62).domains.loading() ? '1' : '0',
				__webpack_require__(/*! Stores/Admin/Plugin */ 65).plugins.loading() ? '1' : '0',
				__webpack_require__(/*! Stores/Admin/Package */ 64).packages.loading() ? '1' : '0'
			].join('');
		}, this);
	...
	PaneSettingsAdminView.prototype.logoutClick = function ()
	{
		Remote.adminLogout(function () {
			__webpack_require__(/*! App/Admin */ 15).loginAndLogoutReload(true);
		});
	};
...
__webpack_require__(/*! bootstrap */ 41)(__webpack_require__(/*! App/Admin */ 15));
