...
(function () {
	...
	var
		...
		Autolinker = __webpack_require__(/*! Autolinker */ 73),
		JSEncrypt = __webpack_require__(/*! JSEncrypt */ 74),
	...
	Utils.mailToHelper = function (sMailToUrl, PopupComposeVoreModel)
	{
		if (sMailToUrl && 'mailto:' === sMailToUrl.toString().substr(0, 7).toLowerCase())
		{
			...
			var
				...
				aBcc = null,
				oParams = {},
				EmailModel = __webpack_require__(/*! Model/Email */ 24),
			...
			__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(PopupComposeVoreModel, [Enums.ComposeType.Empty, null,
				aTo, aCc, aBcc,
...
(function () {
	...
	var
		...
		$ = __webpack_require__(/*! $ */ 11),
		ko = __webpack_require__(/*! ko */ 2),
		hasher = __webpack_require__(/*! hasher */ 78),
		crossroads = __webpack_require__(/*! crossroads */ 40),
...
(function () {
	...
	var
		...
		_ = __webpack_require__(/*! _ */ 1),
		$ = __webpack_require__(/*! $ */ 11),
		moment = __webpack_require__(/*! moment */ 32),
		SimplePace = __webpack_require__(/*! SimplePace */ 77),
		Tinycon = __webpack_require__(/*! Tinycon */ 162),

		Enums = __webpack_require__(/*! Common/Enums */ 3),
		Globals = __webpack_require__(/*! Common/Globals */ 6),
		Consts = __webpack_require__(/*! Common/Consts */ 14),
		Plugins = __webpack_require__(/*! Common/Plugins */ 20),
		Utils = __webpack_require__(/*! Common/Utils */ 0),
		Links = __webpack_require__(/*! Common/Links */ 12),
		Events = __webpack_require__(/*! Common/Events */ 27),
		Translator = __webpack_require__(/*! Common/Translator */ 7),
		...
		SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 22),
		...
		PgpStore = __webpack_require__(/*! Stores/User/Pgp */ 25),
		...
		Remote = __webpack_require__(/*! Remote/User/Ajax */ 13),

		EmailModel = __webpack_require__(/*! Model/Email */ 24),
		FolderModel = __webpack_require__(/*! Model/Folder */ 102),
		AccountModel = __webpack_require__(/*! Model/Account */ 97),
		IdentityModel = __webpack_require__(/*! Model/Identity */ 105),
		TemplateModel = __webpack_require__(/*! Model/Template */ 108),
		OpenPgpKeyModel = __webpack_require__(/*! Model/OpenPgpKey */ 107),
	...
	AppUser.prototype.deleteMessagesFromFolder = function (iDeleteType, sFromFolderFullNameRaw, aUidForRemove, bUseFolder)
	{
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/Ask */ 39), [Translator.i18n('POPUPS_ASK/DESC_WANT_DELETE_MESSAGES'), function () {
...
//		});
	...
	AppUser.prototype.bootstartLoginScreen = function ()
	{
		...
		if (!sCustomLoginLink)
		{
			...
			kn.startScreens([
				__webpack_require__(/*! Screen/User/Login */ 112)
			]);
	...
	AppUser.prototype.bootstart = function ()
	{
		...
		__webpack_require__(/*! Stores/User/Settings */ 22).populate();
		...
		var
			self = this,
			$LAB = __webpack_require__(/*! $LAB */ 159),
...
//require.ensure([], function() { // require code splitting
			...
			self.folders(_.bind(function (bValue) {
				...
				if (bValue)
				{
					...
					kn.startScreens([
						__webpack_require__(/*! Screen/User/MailBox */ 113),
						__webpack_require__(/*! Screen/User/Settings */ 114),
						__webpack_require__(/*! Screen/User/About */ 111)
					]);
					...
					if (!!Settings.settingsGet('AccountSignMe') && window.navigator.registerProtocolHandler)
					{
						_.delay(function () {
							...
							{
								Utils.mailToHelper(Settings.settingsGet('MailToEmail'), __webpack_require__(/*! View/Popup/Compose */ 23));
							}
						}, 500);
					}
...
(function () {
	...
	RemoteUserStorage.prototype.folderInformation = function (fCallback, sFolder, aList)
	{
		...
		{
			__webpack_require__(/*! App/User */ 5).reloadFlagsCurrentMessageListAndMessageFromCache();
		}
	};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../../~/webpack/buildin/module.js */ 72)(module)))
...
(function () {
	...
	Plugins.prototype.runSettingsViewModelHooks = function (bAdmin)
	{
		_.each(bAdmin ? this.aAdminViewModelsHooks : this.aUserViewModelsHooks, function (aView) {
			__webpack_require__(/*! Knoin/Knoin */ 4).addSettingsViewModel(aView[0], aView[1], aView[2], aView[3]);
		});
	};
...
(function () {
	...
	var
		...
		ko = __webpack_require__(/*! ko */ 2),
		moment = __webpack_require__(/*! moment */ 32),
		JSON = __webpack_require__(/*! JSON */ 75),
		Jua = __webpack_require__(/*! Jua */ 76),
	...
	function ComposePopupView()
	{
		...
		this.deleteCommand = Utils.createCommand(this, function () {
			...
			__webpack_require__(/*! App/User */ 5).deleteMessagesFromFolderWithoutCheck(this.draftFolder(), [this.draftUid()]);
	...
	{
		__webpack_require__(/*! App/User */ 5).getAutocomplete(oData.term, function (aData) {
	...
	ComposePopupView.prototype.openOpenPgpPopup = function ()
	{
		...
		{
			var self = this;
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/ComposeOpenPgp */ 144), [
				function (sResult) {
	...
	ComposePopupView.prototype.reloadDraftFolder = function ()
	{
		...
		if ('' !== sDraftFolder)
		{
			...
			{
				__webpack_require__(/*! App/User */ 5).reloadMessageList(true);
			}
			else
			{
				__webpack_require__(/*! App/User */ 5).folderInformation(sDraftFolder);
			}
		}
	};
...
(function () {
	...
	var
		...
		MessageModel = __webpack_require__(/*! Model/Message */ 106)
	;
	...
	MessageUserStore.prototype.subscribers = function ()
	{
		...
		this.message.subscribe(function (oMessage) {
			if (!oMessage)
			{
				...
				{
					__webpack_require__(/*! App/User */ 5).historyBack();
				}
			}
	...
	MessageUserStore.prototype.setMessage = function (oData, bCached)
	{
			...
			oMessage.folderFullNameRaw === oData.Result.Folder && oMessage.uid === oData.Result.Uid)
		{
			...
			if (oMessagesBodiesDom)
			{
				...
				if (!oTextBody || !oTextBody[0])
				{
					...
					else if (Utils.isNormal(oData.Result.Plain) && '' !== oData.Result.Plain)
					{
						...
						if ((oMessage.isPgpSigned() || oMessage.isPgpEncrypted()) && __webpack_require__(/*! Stores/User/Pgp */ 25).capaOpenPGP())
						{
			...
			if (oMessage.unseen())
			{
				__webpack_require__(/*! App/User */ 5).setMessageSeen(oMessage);
			}
	...
	MessageUserStore.prototype.setMessageList = function (oData, bCached)
	{
			...
			oData.Result['@Collection'] && Utils.isArray(oData.Result['@Collection']))
		{
			...
			{
				__webpack_require__(/*! App/User */ 5).folderInformation(oFolder.fullNameRaw, aList);
			}
		}
		else
		{
...
(function () {
	...
	{
		var
			NextStorageDriver = __webpack_require__(/*! _ */ 1).find([
...
//		});
	...
	AbstractApp.prototype.bootstart = function ()
	{
		...
		var
			ssm = __webpack_require__(/*! ssm */ 79),
			ko = __webpack_require__(/*! ko */ 2)
		;
...
//			ko.components.register('Checkbox', require('Component/Classic/Checkbox'));
		...
		__webpack_require__(/*! Stores/Theme */ 38).populate();
...
(function () {
	...
	var
		...
		AbstracCheckbox = __webpack_require__(/*! Component/AbstracCheckbox */ 37)
	;
...
(function () {
	...
	var
		window = __webpack_require__(/*! window */ 10),
		ko = __webpack_require__(/*! ko */ 2),
		buzz = __webpack_require__(/*! buzz */ 163),
		...
		this.addAccountCommand = Utils.createCommand(this, function () {
			...
			Remote.accountSetup(_.bind(function (sResult, oData) {
				...
				if (Enums.StorageResultType.Success === sResult && oData)
				{
					if (oData.Result)
					{
						__webpack_require__(/*! App/User */ 5).accountsAndIdentities();
						this.cancelCommand();
					}
					else
					{
...
(function () {
	...
	function ContactsPopupView()
	{
		...
		this.newMessageCommand = Utils.createCommand(this, function () {
			...
			if (Utils.isNonEmptyArray(aE))
			{
				...
				_.delay(function () {
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 23),
		...
		this.syncCommand = Utils.createCommand(this, function () {
			...
			var self = this;
			__webpack_require__(/*! App/User */ 5).contactsSync(function (sResult, oData) {
				if (Enums.StorageResultType.Success !== sResult || !oData || !oData.Result)
				{
	...
	{
		__webpack_require__(/*! App/User */ 5).download(Links.exportContactsVcf());
	};

	ContactsPopupView.prototype.exportCsv = function ()
	{
		__webpack_require__(/*! App/User */ 5).download(Links.exportContactsCsv());
	};
...
(function () {
    ...
    var
        ...
        GroupsStore = __webpack_require__(/*! Stores/User/Group */ 137),
        GroupModel = __webpack_require__(/*! Model/Group */ 103),

        GroupContactStore = __webpack_require__(/*! Stores/User/GroupContact */ 138),
        GroupContactModel = __webpack_require__(/*! Model/GroupContact */ 104)
        ;
...
(function () {
	...
	var
		...
		AbstractModel = __webpack_require__(/*! Knoin/AbstractModel */ 19)
	;
	...
	function FolderCreateView()
	{
		...
		this.createFolder = Utils.createCommand(this, function () {
			...
			Remote.folderCreate(function (sResult, oData) {
				...
				if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
				{
					__webpack_require__(/*! App/User */ 5).folders();
				}
				else
				{
		...
		this.addTemplateCommand = Utils.createCommand(this, function () {
			...
			Remote.templateSetup(_.bind(function (sResult, oData) {
				...
				if (Enums.StorageResultType.Success === sResult && oData)
				{
					if (oData.Result)
					{
						__webpack_require__(/*! App/User */ 5).templates();
						this.cancelCommand();
					}
					else if (oData.ErrorCode)
					{
...
(function () {
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/KeyboardShortcutsHelp */ 91));
	};
	...
	AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
	{
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 69));
		}
	};

	AbstractSystemDropDownUserView.prototype.logoutClick = function ()
	{
		__webpack_require__(/*! App/User */ 5).logout();
	};
...
(function () {
	...
	MessageModel.prototype.initUpdateByMessageJson = function (oJsonMessage)
	{
		...
		if (oJsonMessage && 'Object/Message' === oJsonMessage['@Object'])
		{
			...
			if (__webpack_require__(/*! Stores/User/Pgp */ 25).capaOpenPGP())
			{
	...
	{
		if (this.body && __webpack_require__(/*! Stores/User/Pgp */ 25).capaOpenPGP())
		{
			this.body.data('rl-pgp-verify-status', this.pgpSignedVerifyStatus());
			this.body.data('rl-pgp-verify-user', this.pgpSignedVerifyUser());
		}
...
(function () {
	...
	function AboutUserScreen()
	{
		AbstractScreen.call(this, 'about', [
			__webpack_require__(/*! View/User/About */ 150)
		]);
	}
	...
	{
		__webpack_require__(/*! App/User */ 5).setWindowTitle('RainLoop');
	};
...
(function () {
	...
	function LoginUserScreen()
	{
		AbstractScreen.call(this, 'login', [
			__webpack_require__(/*! View/User/Login */ 151)
		]);
	}
	...
	{
		__webpack_require__(/*! App/User */ 5).setWindowTitle('');
	};
...
(function () {
	...
	function MailBoxUserScreen()
	{
		AbstractScreen.call(this, 'mailbox', [
			__webpack_require__(/*! View/User/MailBox/SystemDropDown */ 155),
			__webpack_require__(/*! View/User/MailBox/FolderList */ 152),
			__webpack_require__(/*! View/User/MailBox/MessageList */ 153),
			__webpack_require__(/*! View/User/MailBox/MessageView */ 154)
		]);
	...
	MailBoxUserScreen.prototype.updateWindowTitle  = function ()
	{
		...
		__webpack_require__(/*! App/User */ 5).setWindowTitle(('' === sEmail ? '' : '' +
	...
	MailBoxUserScreen.prototype.onRoute = function (sFolderHash, iPage, sSearch, bPreview)
	{
		...
		else
		{
			...
			if (oFolder)
			{
				...
				__webpack_require__(/*! App/User */ 5).reloadMessageList();
			}
		}
	};
	...
	MailBoxUserScreen.prototype.onBuild = function ()
	{
		...
		{
			_.defer(function () {
				__webpack_require__(/*! App/User */ 5).initHorizontalLayoutResizer(Enums.ClientSideKeyName.MessageListSize);
			});
		}
	};
...
(function () {
	...
	function SettingsUserScreen()
	{
		AbstractSettingsScreen.call(this, [
			__webpack_require__(/*! View/User/Settings/SystemDropDown */ 158),
			__webpack_require__(/*! View/User/Settings/Menu */ 156),
			__webpack_require__(/*! View/User/Settings/Pane */ 157)
		]);
	...
	{
		kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/General */ 131),
			'SettingsGeneral', 'SETTINGS_LABELS/LABEL_GENERAL_NAME', 'general', true);

		if (AppStore.contactsIsAllowed())
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Contacts */ 128),
				'SettingsContacts', 'SETTINGS_LABELS/LABEL_CONTACTS_NAME', 'contacts');
		}

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Accounts */ 126), 'SettingsAccounts',
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Filters */ 129),
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Security */ 133),
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Social */ 134),
				'SettingsSocial', 'SETTINGS_LABELS/LABEL_SOCIAL_NAME', 'social');
		}

		if (Settings.settingsGet('ChangePasswordIsAllowed'))
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/ChangePassword */ 127),
				'SettingsChangePassword', 'SETTINGS_LABELS/LABEL_CHANGE_PASSWORD_NAME', 'change-password');
		}

		if (Settings.capa(Enums.Capa.Templates))
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Templates */ 135),
				'SettingsTemplates', 'SETTINGS_LABELS/LABEL_TEMPLATES_NAME', 'templates');
		}

		kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Folders */ 130),
			'SettingsFolders', 'SETTINGS_LABELS/LABEL_FOLDERS_NAME', 'folders');

		if (Settings.capa(Enums.Capa.Themes))
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Themes */ 136),
				'SettingsThemes', 'SETTINGS_LABELS/LABEL_THEMES_NAME', 'themes');
		}

		if (Settings.capa(Enums.Capa.OpenPGP))
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/OpenPgp */ 132),
	...
	{
		__webpack_require__(/*! App/User */ 5).setWindowTitle(this.sSettingsTitle);
	};
...
(function () {
	...
	AccountsUserSettings.prototype.editAccount = function (oAccountItem)
	{
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 69), [oAccountItem]);
		}
	};

	AccountsUserSettings.prototype.addNewIdentity = function ()
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 90));
	};

	AccountsUserSettings.prototype.editIdentity = function (oIdentity)
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 90), [oIdentity]);
	};
...
(function () {
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 89));
	};

	FoldersUserSettings.prototype.systemFolder = function ()
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 45));
	};
...
(function () {
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Languages */ 46));
	};
...
(function () {
	...
	{
		kn.showScreenPopup(__webpack_require__(/*! View/Popup/AddOpenPgpKey */ 142));
	};
	...
	OpenPgpUserSettings.prototype.deleteOpenPgpKey = function (oOpenPgpKeyToRemove)
	{
		if (oOpenPgpKeyToRemove && oOpenPgpKeyToRemove.deleteAccess())
		{
			...
			if (oOpenPgpKeyToRemove && PgpStore.openpgpKeyring)
			{
				...
				__webpack_require__(/*! App/User */ 5).reloadOpenPgpKeys();
			}
		}
	};
...
(function () {
	...
	var
		...
		SettinsStore = __webpack_require__(/*! Stores/User/Settings */ 22),
...
(function () {
	...
	function SocialUserSettings()
	{
		...
		this.connectGoogle = Utils.createCommand(this, function () {
			...
			{
				__webpack_require__(/*! App/User */ 5).googleConnect();
			}
		}, function () {
		...
		this.disconnectGoogle = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).googleDisconnect();
		});

		this.connectFacebook = Utils.createCommand(this, function () {
			if (!this.facebookLoggined())
			{
				__webpack_require__(/*! App/User */ 5).facebookConnect();
			}
		}, function () {
		...
		this.disconnectFacebook = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).facebookDisconnect();
		});

		this.connectTwitter = Utils.createCommand(this, function () {
			if (!this.twitterLoggined())
			{
				__webpack_require__(/*! App/User */ 5).twitterConnect();
			}
		}, function () {
		...
		this.disconnectTwitter = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).twitterDisconnect();
		});
	}
...
(function () {
	...
	{
		__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 92));
	};
	...
	TemplatesUserSettings.prototype.editTemplate = function (oTemplateItem)
	{
		if (oTemplateItem)
		{
			__webpack_require__(/*! Knoin/Knoin */ 4).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 92), [oTemplateItem]);
		}
	};
...
(function () {
	...
	var
		...
		ThemeStore = __webpack_require__(/*! Stores/Theme */ 38),
					...
					Remote.login(_.bind(function (sResult, oData) {
						...
						if (Enums.StorageResultType.Success === sResult && oData && 'Login' === oData.Action)
						{
							if (oData.Result)
							{
								...
								{
									__webpack_require__(/*! App/User */ 5).redirectToAdminPanel();
								}
								else
								{
									__webpack_require__(/*! App/User */ 5).loginAndLogoutReload();
								}
							}
							else if (oData.ErrorCode)
							{
...
(function () {
		...
		oDom
			.on('click', '.b-folders .e-item .e-link .e-collapsed-sign', function (oEvent) {
				...
				if (oFolder && oEvent)
				{
					...
					__webpack_require__(/*! App/User */ 5).setExpandedFolder(oFolder.fullNameHash, bCollapsed);
	...
	FolderListMailBoxUserView.prototype.messagesDropOver = function (oFolder)
	{
		...
		if (oFolder && oFolder.collapsed())
		{
			this.iDropOverTimer = window.setTimeout(function () {
				...
				__webpack_require__(/*! App/User */ 5).setExpandedFolder(oFolder.fullNameHash, true);
				Utils.windowResize();
			}, 500);
		}
	};
	...
	FolderListMailBoxUserView.prototype.messagesDrop = function (oToFolder, oUi)
	{
		if (oToFolder && oUi && oUi.helper)
		{
			...
			{
				__webpack_require__(/*! App/User */ 5).moveMessagesToFolder(sFromFolderFullNameRaw, aUids, oToFolder.fullNameRaw, bCopy);
			}
		}
	};
...
(function () {
	...
	var
		...
		key = __webpack_require__(/*! key */ 18),
		Jua = __webpack_require__(/*! Jua */ 76),
		ifvisible = __webpack_require__(/*! ifvisible */ 164),
	...
	function MessageListMailBoxUserView()
	{
		...
		this.clearCommand = Utils.createCommand(this, function () {
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderClear */ 145), [FolderStore.currentFolder()]);
		});
		...
		this.deleteWithoutMoveCommand = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).deleteMessagesFromFolder(Enums.FolderType.Trash,
		...
		this.archiveCommand = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).deleteMessagesFromFolder(Enums.FolderType.Archive,
				FolderStore.currentFolderFullNameRaw(),
				MessageStore.messageListCheckedOrSelectedUidsWithSubMails(), true);
		}, this.canBeMoved);

		this.spamCommand = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).deleteMessagesFromFolder(Enums.FolderType.Spam,
				FolderStore.currentFolderFullNameRaw(),
				MessageStore.messageListCheckedOrSelectedUidsWithSubMails(), true);
		}, this.canBeMoved);

		this.notSpamCommand = Utils.createCommand(this, function () {
			__webpack_require__(/*! App/User */ 5).deleteMessagesFromFolder(Enums.FolderType.NotSpam,
				FolderStore.currentFolderFullNameRaw(),
				MessageStore.messageListCheckedOrSelectedUidsWithSubMails(), true);
		}, this.canBeMoved);
		...
		this.reloadCommand = Utils.createCommand(this, function () {
			...
			{
				__webpack_require__(/*! App/User */ 5).reloadMessageList(false, true);
			}
		});
	...
	MessageListMailBoxUserView.prototype.moveSelectedMessagesToFolder = function (sToFolderFullNameRaw, bCopy)
	{
		if (this.canBeMoved())
		{
			__webpack_require__(/*! App/User */ 5).moveMessagesToFolder(
				FolderStore.currentFolderFullNameRaw(),
	...
	{
		kn.showScreenPopup(__webpack_require__(/*! View/Popup/AdvancedSearch */ 143));
	};
	...
	MessageListMailBoxUserView.prototype.initUploaderForAppend = function ()
	{
		...
		oJua
			...
			.on('onComplete', _.bind(function () {
				__webpack_require__(/*! App/User */ 5).reloadMessageList(true, true);
			}, this))
		;
...
(function () {
	...
	var
		...
		PhotoSwipe = __webpack_require__(/*! PhotoSwipe */ 160),
		PhotoSwipeUI_Default = __webpack_require__(/*! PhotoSwipeUI_Default */ 161),
...
//					sResult = 'icon-warning-alt iconcolor-green';
	...
	{
		kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 23), [sType, MessageStore.message()]);
	};
...
//							'getThumbBoundsFn': fThumbBoundsFn,
		...
		oDom
			.on('click', 'a', function (oEvent) {
				...
				return !(!!oEvent && 3 !== oEvent['which'] && Utils.mailToHelper($(this).attr('href'), __webpack_require__(/*! View/Popup/Compose */ 23)));
			})
			...
			.on('click', '.attachmentsPlace .attachmentItem .attachmentNameParent', function () {
				...
				if (oAttachment && oAttachment.download)
				{
					__webpack_require__(/*! App/User */ 5).download(oAttachment.linkDownload());
				}
			})
		;
	...
	MessageViewMailBoxUserView.prototype.editMessage = function ()
	{
		if (MessageStore.message())
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 23), [Enums.ComposeType.Draft, MessageStore.message()]);
		}
	};
...
__webpack_require__(/*! bootstrap */ 41)(__webpack_require__(/*! App/User */ 5));
